...
public class GridEditor : Editor
{
    ...
    void OnSceneGUI()
    {
        ...
        if (!isExecuted)
        {
            ...
            balloonGoalStr = myTarget.myGoal.bottleCount.ToString();
            duckGoalStr = myTarget.myGoal.batCount.ToString();
        ...
        Handles.BeginGUI();
        {
            ...
            GUILayout.BeginArea(new Rect(50, 10, 560, 150), new GUIStyle("window"));
            {
                ...
                if (GUILayout.Button("Update Moves Count and Goals"))
                {
                    ...
                    myTarget.myGoal.batCount = duckGoal;

                    int.TryParse(balloonGoalStr, out balloonGoal);
                    myTarget.myGoal.bottleCount = balloonGoal;
